...
class ComponentTypeDefinition extends Definition
{
    const PROFILES = 100;
    ...
    const PLATFORM_SILVER = 105;
    const CHARACTERS = 200;
    const CHARACTER_IVENTORIES = 201;
    ...
    const ITEM_TALENTS_GRID = 306;
    const ITEM_COMMON_DATA = 307;
    const ITEM_PLUG_STATES = 308;
    const ITEM_PLUG_OBJECTIVES = 309;
    const ITEM_REUSABLE_PLUGS = 310;
    const VENDORS = 400;
    const VENDOR_CATEGORIES = 401;
    const VENDOR_SALES = 402;
    const KIOSKS = 500;
    const CURRENCY_LOOKUPS = 600;
